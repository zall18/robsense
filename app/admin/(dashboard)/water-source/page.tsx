          ...
          <table className="w-full text-sm text-left">
            <thead className="text-[10px] uppercase font-bold tracking-wider text-[var(--color-text-secondary)] border-b border-[var(--color-border-base)]">
              <tr>
                ...
                <th className="px-6 py-4 text-center">Warga Terdaftar</th>
                <th className="px-6 py-4 w-1/4">Rasio Sumber Air (Tanah vs PDAM)</th>
                ...
                return (
                  <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-5 text-center">
                      <span className="bg-blue-50 text-[#2563EB] border border-blue-200 px-2.5 py-1 rounded-md text-xs font-bold">
                        {row.pendaftarEdukasi.toLocaleString('id-ID')} warga
                      </span>
                    </td>
                    <td className="px-6 py-5">
