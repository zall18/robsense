  ...
  return (
    <div className="flex flex-col min-h-full bg-[#F8F9FB] p-6 pb-8 pt-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 flex flex-col items-center text-center">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mb-4 overflow-hidden shadow-sm">
          <Image src="/logo.jpeg" alt="Robsense Logo" width={80} height={80} className="object-cover" />
        </div>
