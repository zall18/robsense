/**
 * Geo Utilities & Deterministic Coordinate Mapping (RobSense)
 * Memetakan koordinat kecamatan dan memberikan jitter deterministik
 * agar marker laporan warga tidak tumpang tindih namun tetap konsisten.
 */
 ...
 */
export function deterministicOffset(id: string, seed: number): number {
  let hash = seed;
...
/**
 * Menambahkan koordinat lintang & bujur pada laporan jika belum tersedia.
 */
export function assignCoordinates<T extends ReportWithLocation>(reports: T[]): T[] {
...
export default assignCoordinates;
